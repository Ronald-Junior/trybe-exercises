window.onload = function () {
    ...
    document.querySelector("#criarCV").addEventListener("click", (e) => {
      e.preventDefault();
      criaCV();
    });
  
    document.querySelector("#apagarDados").addEventListener("click", apagarDados);
  };
  function criaCV() {
  ...
  function selectAllDada() {
    ...
    let criarCV = document.querySelector("#criarCV");
    let cargo = document.querySelector("#cargo");
    let descricaoCargo = document.querySelector("#descricaoCargo");
    let dataInicio = document.querySelector('input[type="date"]');
  
    dados.push(nome, email, cpf, endereco, cidade, estados, moradia, criarCV, cargo, descricaoCargo, dataInicio);
